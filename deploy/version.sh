...
#
# Point SOURCE_FILE at the ONE file that declares this project's version, and adjust read_version
# to match its shape. A repo that also publishes a NuGet versions that separately — the package
# ships the DEPLOYABLE's version, so point at that one.
...
SOURCE_FILE="${HERE}/../src/Daemon/kgsm-speech.csproj"
